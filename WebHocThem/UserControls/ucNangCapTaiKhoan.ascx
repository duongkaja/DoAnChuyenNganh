...
<asp:Panel ID="Panel3" runat="server" DefaultButton="btnRegister" style="
    text-align: center;
    font-size: x-large;">
...
<p class="fieldset">
    ...
    <asp:Button ID="btnRegister" runat="server" OnClick="CreatePDK_Click" Text="Xác nhận" CssClass="btn-edit"/>
